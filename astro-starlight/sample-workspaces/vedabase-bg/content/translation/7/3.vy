`set meta { urn = "urn:vedabase:bg:7.3" }
    `v 3 [
        `interlinear-streams { id="synonyms" pattern="term, meaning" }
        `synonyms [
            `term { iast="manuṣyāṇām" } `meaning [of men]
            `term { iast="sahasreṣu" } `meaning [out of many thousands]
            `term { iast="kaścit" } `meaning [someone]
            `term { iast="yatati" } `meaning [endeavors]
            `term { iast="siddhaye" } `meaning [for perfection]
            `term { iast="yatatām" } `meaning [of those so endeavoring]
            `term { iast="api" } `meaning [indeed]
            `term { iast="siddhānām" } `meaning [of those who have achieved perfection]
            `term { iast="kaścit" } `meaning [someone]
            `term { iast="mām" } `meaning [Me]
            `term { iast="vetti" } `meaning [does know]
            `term { iast="tattvataḥ" } `meaning [in fact.]
        ]
        `translation [
