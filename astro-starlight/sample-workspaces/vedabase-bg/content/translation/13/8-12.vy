`set meta { urn = "urn:vedabase:bg:13.8-12" }
    `v 8-12 [
        ...
        `synonyms [
            ...
            `term { iast="adambhitvam" } `meaning [pridelessness]
            `term { iast="ahiṁsā" } `meaning [nonviolence]
            `term { iast="kṣāntiḥ" } `meaning [tolerance]
            `term { iast="ārjavam" } `meaning [simplicity]
            `term { iast="ācārya-upāsanam" } `meaning [approaching a bona fide spiritual master]
            `term { iast="śaucam" } `meaning [cleanliness]
            `term { iast="sthairyam" } `meaning [steadfastness]
            `term { iast="ātma-vinigrahaḥ" } `meaning [self-control]
            `term { iast="indriya-artheṣu" } `meaning [in the matter of the senses]
            `term { iast="vairāgyam" } `meaning [renunciation]
            `term { iast="anahaṅkāraḥ" } `meaning [being without false egoism]
            `term { iast="eva" } `meaning [certainly]
            `term { iast="ca" } `meaning [also]
            `term { iast="janma" } `meaning [of birth]
            `term { iast="mṛtyu" } `meaning [death]
            `term { iast="jarā" } `meaning [old age]
            `term { iast="vyādhi" } `meaning [and disease]
            `term { iast="duḥkha" } `meaning [of the distress]
            `term { iast="doṣa" } `meaning [the fault]
            `term { iast="anudarśanam" } `meaning [observing]
            `term { iast="asaktiḥ" } `meaning [being without attachment]
            `term { iast="anabhiṣvaṅgaḥ" } `meaning [being without association]
            `term { iast="putra" } `meaning [for son]
            `term { iast="dāra" } `meaning [wife]
            `term { iast="gṛha-ādiṣu" } `meaning [home, etc.]
            `term { iast="nityam" } `meaning [constant]
            `term { iast="ca" } `meaning [also]
            `term { iast="sama-cittatvam" } `meaning [equilibrium]
            `term { iast="iṣṭa" } `meaning [the desirable]
            `term { iast="aniṣṭa" } `meaning [and undesirable]
            `term { iast="upapattiṣu" } `meaning [having obtained]
            `term { iast="mayi" } `meaning [unto Me]
            `term { iast="ca" } `meaning [also]
            `term { iast="ananya-yogena" } `meaning [by unalloyed devotional service]
            `term { iast="bhaktiḥ" } `meaning [devotion]
            `term { iast="avyabhicāriṇī" } `meaning [without any break]
            `term { iast="vivikta" } `meaning [to solitary]
            `term { iast="deśa" } `meaning [places]
            `term { iast="sevitvam" } `meaning [aspiring]
            `term { iast="aratiḥ" } `meaning [being without attachment]
            `term { iast="jana-saṁsadi" } `meaning [to people in general]
            `term { iast="adhyātma" } `meaning [pertaining to the self]
            `term { iast="jñāna" } `meaning [in knowledge]
            `term { iast="nityatvam" } `meaning [constancy]
            `term { iast="tattva-jñāna" } `meaning [of knowledge of the truth]
            `term { iast="artha" } `meaning [for the object]
            `term { iast="darśanam" } `meaning [philosophy]
            `term { iast="etat" } `meaning [all this]
            `term { iast="jñānam" } `meaning [knowledge]
            `term { iast="iti" } `meaning [thus]
            `term { iast="proktam" } `meaning [declared]
            `term { iast="ajñānam" } `meaning [ignorance]
            `term { iast="yat" } `meaning [that which]
            `term { iast="ataḥ" } `meaning [from this]
            `term { iast="anyathā" } `meaning [other.]
        ]
        `translation [
