`set meta { urn = "urn:vedabase:bg:1.24" }
`sanjaya `uvacha
    `v 24 [
        `interlinear-streams { id="synonyms" pattern="term, meaning" }
        `synonyms [
            `term { iast="sañjayaḥ uvāca" } `meaning [Sañjaya said]
            `term { iast="evam" } `meaning [thus]
            `term { iast="uktaḥ" } `meaning [addressed]
            `term { iast="hṛṣīkeśaḥ" } `meaning [Lord Kṛṣṇa]
            `term { iast="guḍākeśena" } `meaning [by Arjuna]
            `term { iast="bhārata" } `meaning [O descendant of Bharata]
            `term { iast="senayoḥ" } `meaning [of the armies]
            `term { iast="ubhayoḥ" } `meaning [both]
            `term { iast="madhye" } `meaning [in the midst]
            `term { iast="sthāpayitvā" } `meaning [placing]
            `term { iast="ratha-uttamam" } `meaning [the finest chariot.]
        ]
        `translation [
