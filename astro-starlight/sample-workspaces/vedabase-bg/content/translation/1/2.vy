...
`sanjaya `uvacha
    `v 2 [
        ...
        `synonyms [
            ...
            `term { iast="pāṇḍava-anīkam" } `meaning [the soldiers of the Pāṇḍavas]
            `term { iast="vyūḍham" } `meaning [arranged in a military phalanx]
            `term { iast="duryodhanaḥ" } `meaning [King Duryodhana]
            `term { iast="tadā" } `meaning [at that time]
            `term { iast="ācāryam" } `meaning [the teacher]
            `term { iast="upasaṅgamya" } `meaning [approaching]
            `term { iast="rājā" } `meaning [the king]
            `term { iast="vacanam" } `meaning [words]
