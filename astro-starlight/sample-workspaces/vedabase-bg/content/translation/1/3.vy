`set meta { urn = "urn:vedabase:bg:1.3" }
    `v 3 [
        `interlinear-streams { id="synonyms" pattern="term, meaning" }
        `synonyms [
            `term { iast="paśya" } `meaning [behold]
            `term { iast="etām" } `meaning [this]
            `term { iast="pāṇḍu-putrānām" } `meaning [of the sons of Pāṇḍu]
            `term { iast="ācārya" } `meaning [O teacher]
            `term { iast="mahatīm" } `meaning [great]
            `term { iast="camūm" } `meaning [military force]
            `term { iast="vyūḍhām" } `meaning [arranged]
            `term { iast="drupada-putreṇa" } `meaning [by the son of Drupada]
            `term { iast="tava" } `meaning [your]
            `term { iast="śiṣyeṇa" } `meaning [disciple]
            `term { iast="dhī-matā" } `meaning [very intelligent.]
        ]
        `translation [
