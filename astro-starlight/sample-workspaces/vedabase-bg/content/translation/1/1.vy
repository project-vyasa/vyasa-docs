`set meta { urn = "urn:vedabase:bg:1.1" }
    `v 1 [
        `interlinear-streams { id="synonyms" pattern="term, meaning" }
        `synonyms [
            `term { iast="dhṛtarāṣṭraḥ uvāca" } `meaning [King Dhṛtarāṣṭra said]
            `term { iast="dharma-kṣetre" } `meaning [in the place of pilgrimage]
            `term { iast="kuru-kṣetre" } `meaning [in the place named Kurukṣetra]
            `term { iast="samavetāḥ" } `meaning [assembled]
            `term { iast="yuyutsavaḥ" } `meaning [desiring to fight]
            `term { iast="māmakāḥ" } `meaning [my party (sons)]
            `term { iast="pāṇḍavāḥ" } `meaning [the sons of Pāṇḍu]
            `term { iast="ca" } `meaning [and]
            `term { iast="eva" } `meaning [certainly]
            `term { iast="kim" } `meaning [what]
            `term { iast="akurvata" } `meaning [did they do]
            `term { iast="sañjaya" } `meaning [O Sañjaya.]
        ]
        `translation [
